...
<div class="card shadow">
    ...
    <div class="card-header bg-warning">
        <h4 class="mb-0">Modifier une consommation</h4>
    </div>
    ...
    <div class="card-body">
        ...
        <form action="{{ route('consommations.update', $consommation->id) }}" method="POST">
                ...
                <select name="abonne_id" class="form-control">
                    ...
                    @foreach($abonnes as $abonne)
                        ...
                        <option value="{{ $abonne->id }}"
                            {{ $consommation->abonne_id == $abonne->id ? 'selected' : '' }}>
                            {{ $abonne->nom }}
                        </option>
            ...
            <div class="mb-3">
                ...
                <input type="number" name="ancienne_valeur" class="form-control"
                       value="{{ $consommation->ancienne_valeur }}">
            </div>

            <div class="mb-3">
                <label class="form-label">Nouvel index</label>
                <input type="number" name="nouvelle_valeur" class="form-control"
